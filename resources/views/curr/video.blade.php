...
<head>
	...
	<script src="/enew/js/jquery-1.8.0.min.js"></script>
	<script src="/enew/js/mine.js"></script>
	<script src="/enew/js/jquery.tabs.js"></script>
	<!-- video.js must be in the <head> for older IEs to work. -->
	<link rel="stylesheet" href="/enew/video-js.css" >
	<link rel="stylesheet" href="/enew/css/course.css"/>
	<link rel="stylesheet" href="/enew/css/tab.css" media="screen">
	<script src="/enew/video.js"></script>

	<!-- Unless using the CDN hosted version, update the URL to the Flash SWF -->
	<script>
		videojs.options.flash.swf = "/enew/video-js.swf";
